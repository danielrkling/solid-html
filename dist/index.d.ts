...
export declare const html: (strings: TemplateStringsArray, ...values: any[]) => JSX.Element;
...
export declare const mathml: (strings: TemplateStringsArray, ...values: any[]) => JSX.Element;
...
export declare const svg: (strings: TemplateStringsArray, ...values: any[]) => JSX.Element;
